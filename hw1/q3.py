...
from q2 import knowledge_map, update_known_map, a_star_search, repeated_forward_astar, BLOCKED, UNBLOCKED
...
def repeated_backward_astar(
    ...
    while current_state != goal:
        ...
        potential_path, expansions = a_star_search(goal, current_state, known_map, sign)
        total_expansions += expansions
        
        if potential_path is False:
            #print("No path is possible. Maze cannot be solved.")
        ...
        if not path_blocked and current_state != goal:
